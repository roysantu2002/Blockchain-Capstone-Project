...
contract Pausable is Ownable {
    ...
    modifier paused(){
        require(_paused == true, 'Contract is unpaused');
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != tokenOwner, "You can't approve yourself");
        // TODO require the msg sender to be the owner of the token or isApprovedForAll() to be true
        require(msg.sender == tokenOwner || isApprovedForAll(tokenOwner, msg.sender), "Not authorized against this token");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(to != address(0), "This not a valid address");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    // require the token exists before setting
     function setTokenURI(uint256 tokenId) internal {
        // require the token exists before setting
        require(_exists(tokenId), "This token does not exist or not minted");
